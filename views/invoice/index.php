            ...
            <form method="post" action="<?php echo site_url('invoice/insert_invoice');?>" id="form">
              <div class="box-body">
               <div class="col-md-3">
                 ...
                 <input type="text" name="nama" class="form-control" required Placeholder="Nama Pembeli ">
               </div>
               <div class="col-md-3">
                <strong>Telp</strong>
                    ...
                    <td><input type="text" name="rate[]" id="harga1" class="form-control" Placeholder="Enter rate here ">
                      ...
                      <div class="pull-right">
                        ...
                        <table>
                          <tr>
                            <th>DP</th>
                            <td width="10px">&nbsp;</td><td><input type="text" name="sub_total" id="sub_total"class="form-control"></td>
                            <td></td>
                          </tr>
                          <tr>
                            <td></td>
                          ...
                          <tr>
                            <th>Grand Total</th>
                            <td width="10px">&nbsp;</td><td><input type="text" name="grand_total" id="grand_total" class="form-control"></td>
                            <td></td>
                          </tr>
                        </table>                    
